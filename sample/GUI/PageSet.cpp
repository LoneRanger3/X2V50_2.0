...
void PageSet::CreatePage()
{
	...
	sys_set_list_ = lv_create_page(set_page_, screen_width, size_h(190),
		lv_color_make(16, 16, 16), 0, 0, lv_font_all, lv_color_white(), 0);
	lv_obj_align(sys_set_list_, LV_ALIGN_TOP_MID, size_w(0), size_h(48));
   ...
   uint8_t Total_num =sizeof(sys_menu_config_table)/sizeof(sys_menu_config_table[0]);
	...
	for (int i = 0;i < Total_num;i++) {
		...
		set_btn[i] = lv_create_btn(sys_set_list_, screen_width, 46, lv_color_make(68, 68, 68), 2,
